            ...
            {team.map((member: any, i: number) => (
              <div key={i} className="p-7 bg-white rounded-2xl border border-gray-100 hover:border-violet-200 hover:shadow-xl transition-all text-center group">
                ...
                <div className="flex items-center justify-center gap-3">
                  ...
                  <a href="#" className="w-8 h-8 rounded-lg bg-gray-100 hover:bg-violet-100 flex items-center justify-center text-gray-400 hover:text-violet-600 transition-colors"><Mail className="w-4 h-4" /></a>
                </div>
              </div>
            ))}
          </div>
      ...
      <section className="py-16 px-4">
        <div className="max-w-4xl mx-auto relative overflow-hidden bg-gradient-to-r from-violet-600 via-purple-600 to-fuchsia-600 rounded-3xl p-10 md:p-14 text-center shadow-2xl shadow-violet-200/50">
          ...
          <div className="relative flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link href="/contact" className="w-full sm:w-auto px-8 py-4 bg-white text-violet-700 font-bold rounded-2xl shadow-xl hover:shadow-2xl transition-all hover:-translate-y-0.5">{t.cta.primaryText}</Link>
            <Link href="/about" className="w-full sm:w-auto px-8 py-4 border-2 border-white/30 text-white font-bold rounded-2xl hover:bg-white/10 transition-all">{t.cta.secondaryText}</Link>
          </div>
        </div>
      </section>
